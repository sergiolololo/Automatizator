package com.telefonica.modulos.despliegueCerti.enumm;

public enum ConexionesMaquinasEnumCerti {
	V0_REPO_DES(
			"10.159.5.30",
			"v0",
			"qENMLKJ8",
	...
	ConexionesMaquinasEnumCerti(String hostTramitador, String userTramitador, String passwordTramitador, String directorioWarTramitador,
